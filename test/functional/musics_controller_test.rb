...
class MusicsControllerTest < ActionController::TestCase
  ...
  test "should create music" do
    assert_difference('Music.count') do
      post :create, music: { counter: @music.counter, video: @music.video, video_file_name: @music.video_file_name }
    end
  ...
  test "should update music" do
    put :update, id: @music, music: { counter: @music.counter, video: @music.video, video_file_name: @music.video_file_name }
    assert_redirected_to music_path(assigns(:music))
  end
